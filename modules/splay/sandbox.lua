...
This sandbox will provide standard librairies to the sandboxed code, but
will take everything that will be put in from the actual environnement
...
function protect_env(settings)
	...
	globals = misc.table_concat(settings.globals,
			{"string", "table", "math", "coroutine", "os", "io"})
