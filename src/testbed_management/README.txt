...
2) Generate a new keypair for this Splay cluster: $ssh-keygen. By default it will create a new public ley in ~/.ssh/id_rsa.pub
3) Edit copy-id.sh and edit: the variables USERNAME/PASSWORD, the path to the public key generated in 2)
