...
require 'splay_controller'

# Re-raise errors caught by the controller.
class SplayController; def rescue_action(e) raise e end; end

class SplayControllerTest < Test::Unit::TestCase
  fixtures :splayds

  def setup
    @controller = SplayController.new
