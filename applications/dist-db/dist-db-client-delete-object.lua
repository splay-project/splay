...
function send_delete_object(access_key_id, bucket, object, port, technique)
	...
	if not technique then technique = math.random(2) end
	if technique == 1 then
...
send_delete_object(arg[1], arg[2], arg[3], port, tonumber(arg[5]))